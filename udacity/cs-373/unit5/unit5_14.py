...
def run(param1, param2, param3):
    ...
    sum_crosstrack_error = 0
    for i in range(N):        
        diff_crosstrack_error  = (myrobot.y - crosstrack_error) / 1.0
        crosstrack_error = myrobot.y
        sum_crosstrack_error += crosstrack_error
        steer = -param1 * crosstrack_error - param2 * diff_crosstrack_error  - param3 * sum_crosstrack_error
